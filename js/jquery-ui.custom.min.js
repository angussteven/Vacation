...
(function(t) {
	...
	return t.widget("ui.draggable", t.ui.mouse, {
		...
		drag: function(e, i, s) {
			var o, n, r, a, l, h, c, p, u, f, d = s.options,
				g = d.snapTolerance,
				m = i.offset.left,
			...
			})), s.snapElements[u].snapping = !1) : ("inner" !== d.snapMode && (o = g >= Math.abs(c - b), n = g >= Math.abs(p - _), r = g >= Math.abs(l - v), a = g >= Math.abs(h - m), o && (i.position.top = s._convertPositionTo("relative", {
